...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}2}]:} <matplotlib.image.AxesImage at 0x213a40d2470>
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k+kn}{import} \PY{n+nn}{math}
        ...
        \PY{k}{def} \PY{n+nf}{draw\PYZus{}lines}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{n}{lines}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{255}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{thickness}\PY{o}{=}\PY{l+m+mi}{8}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{c+c1}{\PYZsh{} List for ascending and descending lines for averaging. Separated into X and Y coordinates for polynomial fit}
            \PY{n}{ascendX}\PY{o}{=}\PY{p}{[}\PY{p}{]}
            \PY{n}{ascendY}\PY{o}{=}\PY{p}{[}\PY{p}{]}
            \PY{n}{descendX}\PY{o}{=}\PY{p}{[}\PY{p}{]}
            \PY{n}{descendY}\PY{o}{=}\PY{p}{[}\PY{p}{]}
            ...
            \PY{k}{for} \PY{n}{line} \PY{o+ow}{in} \PY{n}{lines}\PY{p}{:}
                \PY{k}{for} \PY{n}{x1}\PY{p}{,}\PY{n}{y1}\PY{p}{,}\PY{n}{x2}\PY{p}{,}\PY{n}{y2} \PY{o+ow}{in} \PY{n}{line}\PY{p}{:}
                    ...
                    \PY{c+c1}{\PYZsh{} Fitting the first order polynomial to extract the slope and intercept of each individual line}
                    \PY{p}{[}\PY{n}{slope}\PY{p}{,} \PY{n}{intercept}\PY{p}{]} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{polyfit}\PY{p}{(}\PY{p}{[}\PY{n}{x1}\PY{p}{,} \PY{n}{x2}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{y1}\PY{p}{,} \PY{n}{y2}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
        
                    \PY{c+c1}{\PYZsh{} Bifurcating into ascending and descending lines while ignoring near\PYZhy{}vertical lines}
                    \PY{k}{if} \PY{n}{slope} \PY{o}{\PYZgt{}} \PY{l+m+mf}{0.1}\PY{p}{:}
                        \PY{n}{ascendX}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{x1}\PY{p}{)}
                        \PY{n}{ascendX}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{x2}\PY{p}{)}
                        \PY{n}{ascendY}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y1}\PY{p}{)}
                        \PY{n}{ascendY}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y2}\PY{p}{)}
                    \PY{k}{if} \PY{n}{slope} \PY{o}{\PYZlt{}} \PY{o}{\PYZhy{}}\PY{l+m+mf}{0.1}\PY{p}{:}
                        \PY{n}{descendX}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{x1}\PY{p}{)}
                        \PY{n}{descendX}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{x2}\PY{p}{)}
                        \PY{n}{descendY}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y1}\PY{p}{)} 
                        \PY{n}{descendY}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y2}\PY{p}{)} 
            
            \PY{c+c1}{\PYZsh{} Easier to start with known Y parameters and map them to X parameters}
            \PY{n}{y\PYZus{}top} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{(}\PY{n}{horizon\PYZus{}scalar}\PY{o}{*}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}
            \PY{n}{y\PYZus{}bottom} \PY{o}{=} \PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}   
            
            
            \PY{c+c1}{\PYZsh{} Checking if list is populated with coordinates and fitting ascending and descending polynomials}
            \PY{k}{if} \PY{n+nb}{len}\PY{p}{(}\PY{n}{ascendX}\PY{p}{)} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0} \PY{o+ow}{and} \PY{n+nb}{len}\PY{p}{(}\PY{n}{ascendY}\PY{p}{)} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0}\PY{p}{:}
                
                \PY{n}{ascendPoly}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{polyfit}\PY{p}{(}\PY{n}{ascendY}\PY{p}{,} \PY{n}{ascendX}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
                \PY{c+c1}{\PYZsh{} Computing X values with the x = slope * y + intercept formula}
                \PY{n}{x\PYZus{}asc\PYZus{}top} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{(}\PY{n}{y\PYZus{}top}\PY{o}{*}\PY{n}{ascendPoly}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{+} \PY{n}{ascendPoly}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
                \PY{n}{x\PYZus{}asc\PYZus{}bottom} \PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{(}\PY{n}{y\PYZus{}bottom}\PY{o}{*}\PY{n}{ascendPoly}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{+} \PY{n}{ascendPoly}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
                \PY{c+c1}{\PYZsh{} Drawing individual ascending lines}
                \PY{n}{cv2}\PY{o}{.}\PY{n}{line}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{p}{(}\PY{n}{x\PYZus{}asc\PYZus{}top}\PY{p}{,} \PY{n}{y\PYZus{}top}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{x\PYZus{}asc\PYZus{}bottom}\PY{p}{,} \PY{n}{y\PYZus{}bottom}\PY{p}{)}\PY{p}{,} \PY{n}{color}\PY{p}{,} \PY{n}{thickness}\PY{p}{)}
           
            
            \PY{k}{if} \PY{n+nb}{len}\PY{p}{(}\PY{n}{descendX}\PY{p}{)} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0} \PY{o+ow}{and} \PY{n+nb}{len}\PY{p}{(}\PY{n}{descendY}\PY{p}{)} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0}\PY{p}{:}
                \PY{n}{descendPoly}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{polyfit}\PY{p}{(}\PY{n}{descendY}\PY{p}{,} \PY{n}{descendX}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
                \PY{c+c1}{\PYZsh{} Computing X values with the x = slope * y + intercept formula}
                \PY{n}{x\PYZus{}desc\PYZus{}top} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{(}\PY{n}{y\PYZus{}top}\PY{o}{*}\PY{n}{descendPoly}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{+} \PY{n}{descendPoly}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
                \PY{n}{x\PYZus{}desc\PYZus{}bottom} \PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{(}\PY{n}{y\PYZus{}bottom}\PY{o}{*}\PY{n}{descendPoly}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{+} \PY{n}{descendPoly}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
                \PY{c+c1}{\PYZsh{} Drawing individual descending lines}
                \PY{n}{cv2}\PY{o}{.}\PY{n}{line}\PY{p}{(}\PY{n}{img}\PY{p}{,} \PY{p}{(}\PY{n}{x\PYZus{}desc\PYZus{}top}\PY{p}{,} \PY{n}{y\PYZus{}top}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{x\PYZus{}desc\PYZus{}bottom}\PY{p}{,} \PY{n}{y\PYZus{}bottom}\PY{p}{)}\PY{p}{,} \PY{n}{color}\PY{p}{,} \PY{n}{thickness}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}4}]:} ['solidWhiteCurve.jpg',
         'solidWhiteRight.jpg',
...
thresholds as well as the Hough lines parameters.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} TODO: Build your pipeline that will draw lane lines on the test\PYZus{}images}
         \PY{c+c1}{\PYZsh{} then save them to the test\PYZus{}images\PYZus{}output directory.}
         
         \PY{c+c1}{\PYZsh{} Reading the image }
         \PY{c+c1}{\PYZsh{} TBD looping over every image or adding a function to intake image}
         
         \PY{n}{image} \PY{o}{=} \PY{n}{mpimg}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images/solidYellowCurve.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{This image is:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n+nb}{type}\PY{p}{(}\PY{n}{image}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{with dimensions:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{image}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Displaying original image}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{image}\PY{p}{)}  
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}plt.imshow(gray, cmap=\PYZsq{}gray\PYZsq{})}
         
         \PY{c+c1}{\PYZsh{} Creating a copy of image for processing}
         \PY{n}{processed} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} Converting image to the grayscale}
         \PY{n}{processed} \PY{o}{=} \PY{n}{grayscale}\PY{p}{(}\PY{n}{processed}\PY{p}{)}
         \PY{n}{cv2}\PY{o}{.}\PY{n}{imwrite}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images\PYZus{}output/grayScale.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{processed}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} Applying gaussian blur with the selected kernel}
         \PY{n}{processed} \PY{o}{=} \PY{n}{gaussian\PYZus{}blur}\PY{p}{(}\PY{n}{processed}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Gaussian Blur}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{processed}\PY{p}{,}\PY{n}{cmap}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{gray}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}  
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{n}{cv2}\PY{o}{.}\PY{n}{imwrite}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images\PYZus{}output/gaussianBlur.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{processed}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Applying Canny transformation with selected thresholds}
         \PY{n}{processed} \PY{o}{=} \PY{n}{canny}\PY{p}{(}\PY{n}{processed}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{,}\PY{l+m+mi}{150}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Canny Transformation}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{processed}\PY{p}{,}\PY{n}{cmap}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{gray}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}  
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{n}{cv2}\PY{o}{.}\PY{n}{imwrite}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images\PYZus{}output/cannyTransform.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{processed}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} Applying quadrilateral masking}
         \PY{c+c1}{\PYZsh{} Scalar for adjusting horizon line with respect to the camera frame}
         \PY{n}{horizon\PYZus{}scalar} \PY{o}{=} \PY{l+m+mf}{1.25}
         \PY{c+c1}{\PYZsh{} Outlie of the quadrilateral shape for masking}
         \PY{n}{imshape} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{shape}
         \PY{n}{vertices} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{horizon\PYZus{}scalar}\PY{o}{*}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{horizon\PYZus{}scalar}\PY{o}{*}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{]}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}vertices = np.array([[(0,imshape[0]),(450, 280), (490, 280), (imshape[1],imshape[0])]], dtype=np.int32)}
         \PY{n}{processed} \PY{o}{=} \PY{n}{region\PYZus{}of\PYZus{}interest}\PY{p}{(}\PY{n}{processed}\PY{p}{,} \PY{n}{vertices}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Quadrilateral masking}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{processed}\PY{p}{,}\PY{n}{cmap}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{gray}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}  
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{n}{cv2}\PY{o}{.}\PY{n}{imwrite}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images\PYZus{}output/quadrilateralMask.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{processed}\PY{p}{)}
         
         
         \PY{c+c1}{\PYZsh{} Applying Hough lines}
         \PY{n}{rho} \PY{o}{=} \PY{l+m+mi}{3}                 \PY{c+c1}{\PYZsh{} Resolution for distance on the grid}
         \PY{n}{theta} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{180}       \PY{c+c1}{\PYZsh{} Radian resolution}
         \PY{n}{threshold} \PY{o}{=} \PY{l+m+mi}{50}          \PY{c+c1}{\PYZsh{} Votes for intersections}
         \PY{n}{min\PYZus{}line\PYZus{}len} \PY{o}{=} \PY{l+m+mi}{40}       \PY{c+c1}{\PYZsh{} Pixel thresholds for line length}
         \PY{n}{max\PYZus{}line\PYZus{}gap} \PY{o}{=} \PY{l+m+mi}{50}      \PY{c+c1}{\PYZsh{} Gap threshold for line connection}
         
         \PY{n}{processed} \PY{o}{=} \PY{n}{hough\PYZus{}lines}\PY{p}{(}\PY{n}{processed}\PY{p}{,} \PY{n}{rho}\PY{p}{,} \PY{n}{theta}\PY{p}{,} \PY{n}{threshold}\PY{p}{,} \PY{n}{min\PYZus{}line\PYZus{}len}\PY{p}{,} \PY{n}{max\PYZus{}line\PYZus{}gap}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Hough Lines}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{processed}\PY{p}{,}\PY{n}{cmap}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{gray}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}  
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{n}{cv2}\PY{o}{.}\PY{n}{imwrite}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images\PYZus{}output/houghLines.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{processed}\PY{p}{)}
         
         
         \PY{n}{processed} \PY{o}{=} \PY{n}{weighted\PYZus{}img}\PY{p}{(}\PY{n}{processed}\PY{p}{,} \PY{n}{image}\PY{p}{,} \PY{n}{α}\PY{o}{=}\PY{l+m+mf}{0.8}\PY{p}{,} \PY{n}{β}\PY{o}{=}\PY{l+m+mf}{1.}\PY{p}{,} \PY{n}{γ}\PY{o}{=}\PY{l+m+mf}{0.}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Weighted}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{processed}\PY{p}{)}  
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{n}{cv2}\PY{o}{.}\PY{n}{imwrite}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}images\PYZus{}output/weightedImage.jpg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{processed}\PY{p}{)}
\end{Verbatim}
...
forum post} for more troubleshooting tips across operating systems.}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{} Import everything needed to edit/save/watch video clips}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{k}{def} \PY{n+nf}{process\PYZus{}image}\PY{p}{(}\PY{n}{image}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{processed} \PY{o}{=} \PY{n}{grayscale}\PY{p}{(}\PY{n}{processed}\PY{p}{)}
            \PY{c+c1}{\PYZsh{} Applying gaussian blur with the selected kernel}
            \PY{n}{processed} \PY{o}{=} \PY{n}{gaussian\PYZus{}blur}\PY{p}{(}\PY{n}{processed}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} Applying Canny transformation with selected thresholds}
            \PY{n}{processed} \PY{o}{=} \PY{n}{canny}\PY{p}{(}\PY{n}{processed}\PY{p}{,}\PY{l+m+mi}{100}\PY{p}{,}\PY{l+m+mi}{200}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} Applying quadrilateral masking}
            \PY{c+c1}{\PYZsh{} Scalar for adjusting horizon line with respect to the camera frame}
            \PY{n}{horizon\PYZus{}scalar} \PY{o}{=} \PY{l+m+mf}{1.25}
            \PY{c+c1}{\PYZsh{} Outlie of the quadrilateral shape for masking. Triangular area is a good initial approximation}
            \PY{n}{imshape} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{shape}
            \PY{n}{vertices} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{horizon\PYZus{}scalar}\PY{o}{*}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{horizon\PYZus{}scalar}\PY{o}{*}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,}\PY{n}{imshape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{]}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{)}
            \PY{n}{processed} \PY{o}{=} \PY{n}{region\PYZus{}of\PYZus{}interest}\PY{p}{(}\PY{n}{processed}\PY{p}{,} \PY{n}{vertices}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{white\PYZus{}output} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos\PYZus{}output/solidWhiteRight.mp4}\PY{l+s+s1}{\PYZsq{}}
        ...
        \PY{n}{clip1} \PY{o}{=} \PY{n}{VideoFileClip}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test\PYZus{}videos/solidWhiteRight.mp4}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{o}{.}\PY{n}{subclip}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}
        \PY{c+c1}{\PYZsh{}clip1 = VideoFileClip(\PYZdq{}test\PYZus{}videos/solidWhiteRight.mp4\PYZdq{})}
...
[MoviePy] Writing video test\_videos\_output/solidWhiteRight.mp4
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
 99\%|███████████████████████████████████████████████████████████████████████████████▎| 125/126 [00:09<00:00, 13.16it/s]
...
player of choice.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{HTML}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
tricky!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{n}{yellow\PYZus{}output} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos\PYZus{}output/solidYellowLeft.mp4}\PY{l+s+s1}{\PYZsq{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{} To speed up the testing process you may want to try your pipeline on a shorter subclip of the video}
         \PY{c+c1}{\PYZsh{}\PYZsh{} To do so add .subclip(start\PYZus{}second,end\PYZus{}second) to the end of the line below}
         \PY{c+c1}{\PYZsh{}\PYZsh{} Where start\PYZus{}second and end\PYZus{}second are integer values representing the start and end of the subclip}
         \PY{c+c1}{\PYZsh{}\PYZsh{} You may also uncomment the following line for a subclip of the first 5 seconds}
         \PY{n}{clip2} \PY{o}{=} \PY{n}{VideoFileClip}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos/solidYellowLeft.mp4}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{subclip}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}clip2 = VideoFileClip(\PYZsq{}test\PYZus{}videos/solidYellowLeft.mp4\PYZsq{})}
...
[MoviePy] Writing video test\_videos\_output/solidYellowLeft.mp4
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
 99\%|███████████████████████████████████████████████████████████████████████████████▎| 125/126 [00:08<00:00, 13.98it/s]
...
Wall time: 12 s
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{HTML}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+s2}{\PYZlt{}video width=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{960}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{ height=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{540}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{ controls\PYZgt{}}
         \PY{l+s+s2}{  \PYZlt{}source src=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}0\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZgt{}}
         \PY{l+s+s2}{\PYZlt{}/video\PYZgt{}}
...
\hypertarget{for-some-reason-the-lines-concentrate-on-the-middle-of-the-image-despite-defined-quadrilateral-area-coordinates-of-lines-extrapolation}{%
\subsection{For some reason the lines concentrate on the middle of the
image despite defined quadrilateral area + coordinates of lines
extrapolation!}\label{for-some-reason-the-lines-concentrate-on-the-middle-of-the-image-despite-defined-quadrilateral-area-coordinates-of-lines-extrapolation}}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{challenge\PYZus{}output} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos\PYZus{}output/challenge.mp4}\PY{l+s+s1}{\PYZsq{}}
         \PY{c+c1}{\PYZsh{}\PYZsh{} To speed up the testing process you may want to try your pipeline on a shorter subclip of the video}
         \PY{c+c1}{\PYZsh{}\PYZsh{} To do so add .subclip(start\PYZus{}second,end\PYZus{}second) to the end of the line below}
         \PY{c+c1}{\PYZsh{}\PYZsh{} Where start\PYZus{}second and end\PYZus{}second are integer values representing the start and end of the subclip}
         \PY{c+c1}{\PYZsh{}\PYZsh{} You may also uncomment the following line for a subclip of the first 5 seconds}
         \PY{n}{clip3} \PY{o}{=} \PY{n}{VideoFileClip}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test\PYZus{}videos/challenge.mp4}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{subclip}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}clip3 = VideoFileClip(\PYZsq{}test\PYZus{}videos/challenge.mp4\PYZsq{})}
...
[MoviePy] Writing video test\_videos\_output/challenge.mp4
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
 99\%|███████████████████████████████████████████████████████████████████████████████▎| 125/126 [00:22<00:00,  6.32it/s]
